    ...
    if (this.userEnterCaptcha == this.captchatext) {
      ...
      this.activityService.userActivityService(activity, this.file).subscribe((data:any) => {
        ...
        */
        ...
        window.location.href=hrefLink+"?projectType="+this.activity.activityId+
        "&projectSubtype="+this.subActivity.subactivityId+
        "&capacity="+this.capacity+
        "&kmlId="+data.id+
        "&projectTypeName="+this.activity.activity_name+
        "&projectSubtypeName="+this.subActivity.sub_activity_name+
        "&capacityUnit="+this.thresholdUnit;
